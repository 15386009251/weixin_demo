...
//			Element root = document.addElement(obj.getClass().getSimpleName());
	...
	public static void main(String[] args) {
		...
		textMessage.setContent("123张阳阳");
		textMessage.setCreateTime(System.currentTimeMillis()+"");
		textMessage.setFromUserName("zyy");
		textMessage.setMsgId(System.currentTimeMillis()+"");
		textMessage.setMsgType("2");
		textMessage.setToUserName("zwh");
		System.out.println(xmlToString(getXmlByBean(textMessage),"UTF-8",false));;
	}
}
